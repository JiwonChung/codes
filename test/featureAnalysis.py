...
for school in schools:
    ...
    if (generalTeacher_number_tmp != 0):
        # 교사 sexRatio
        list_forTmp.append(generalTeacher_female_number_tmp /
                           generalTeacher_number_tmp)

    # 학생 교사 ratio
    list_forTmp.append(generalTeacher_number_tmp / students_number_tmp)

    # 학생 남교사 ratio
    list_forTmp.append((generalTeacher_number_tmp -
                       generalTeacher_female_number_tmp) / students_number_tmp)
    ...
    # 학교 크기, 교실 수 ratio
    list_forTmp.append(
        schoolSize_tmp / (generalClassNumber_tmp + specialClassNumber_tmp))
