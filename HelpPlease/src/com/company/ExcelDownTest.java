...
//            cellStyle.setAlignment(HSSFCellStyle.ALIGN_CENTER); // 정렬
            ...
            tableCellStyle.setBorderTop(BorderStyle.valueOf((short) 5));    // 테두리 위쪽
            tableCellStyle.setBorderBottom(BorderStyle.valueOf((short) 5)); // 테두리 아래쪽
            tableCellStyle.setBorderLeft(BorderStyle.valueOf((short) 5));   // 테두리 왼쪽
            tableCellStyle.setBorderRight(BorderStyle.valueOf((short) 5));  // 테두리 오른쪽
            ...
            String localFile = "excelDownTest" + ".xlsx";
